...
public class KitProductFilterUtils {
   ...
   */
  private static String[] WRONG_KIT_PRODUCTS = new String[]{"SCOD10", "SCOD10-AL", "SCOD12", "SCOD12-AL"};
  public static final Set<String> WRONG_KIT_PRODUCTS_SET = ConvertArrayToSet(WRONG_KIT_PRODUCTS);
  /**
   * filter right kit product
   */
  private static String[] RIGHT_KIT_PRODUCTS = new String[]{"26A01", "26B01", "26A02", "26B02"};
  ...
  private static Set ConvertArrayToSet(String[] strings) {
