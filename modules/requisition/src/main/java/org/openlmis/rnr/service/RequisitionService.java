...
public class RequisitionService {
    ...
    public List<AlReportData> alReportRequisitions(Date start, Date end, Object provinceId, Object districtId, Object facilityId) {
        if (facilityId != null) {
            return requisitionRepository.getAlReportRequisitionsByFacilityId(start, end, facilityId.toString());
        }
        
        String zoneId = districtId != null ? districtId.toString() : provinceId != null ? provinceId.toString() : null;
        if (zoneId != null) {
            return requisitionRepository.getAlReportRequisitionsByZoneId(start, end, zoneId);
        }
        
        return requisitionRepository.getAlReportRequisitions(start, end);
    }
}
