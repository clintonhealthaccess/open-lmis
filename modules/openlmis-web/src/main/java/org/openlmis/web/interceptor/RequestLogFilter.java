...
public class RequestLogFilter extends AbstractRequestLoggingFilter {
  ...
  private static final String TEMPLATE = "User is %s, FacilityName is %s, Device is %s, Unique Device id is %s, VersionCode is %s, message is %s";
  ...
  protected void afterRequest(HttpServletRequest request, String message) {
    ...
    String device = request.getHeader("DeviceInfo");
    ...
    logger
        .info(String.format(TEMPLATE, userName, facilityName, device, uniqueId, versionCode, info));
  }
}