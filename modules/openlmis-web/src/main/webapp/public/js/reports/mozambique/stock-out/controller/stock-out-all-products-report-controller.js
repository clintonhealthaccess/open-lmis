function StockOutAllProductsReportController($scope, $filter, $q, $controller, $http, CubesGenerateUrlService, messageService, StockOutReportCalculationService, CubesGenerateCutParamsService, $cacheFactory, $timeout, ReportExportExcelService) {
  ...
  function generateReportItem(drug, calculationData) {
    ...
    drug.province = drug[0]['location.province_name'];
    drug.district = drug[0]['location.district_name'];
    drug.facility = drug[0]['facility.facility_name'];
  ...
  $scope.exportXLSX = function () {
    ...
    if ($scope.reportData) {
      $scope.reportData.forEach(function (stockoutReportData) {
        ...
        singleFacilityStockoutReportContent.province = stockoutReportData.province;
        singleFacilityStockoutReportContent.district = stockoutReportData.district;
        singleFacilityStockoutReportContent.facility = stockoutReportData.facility;
