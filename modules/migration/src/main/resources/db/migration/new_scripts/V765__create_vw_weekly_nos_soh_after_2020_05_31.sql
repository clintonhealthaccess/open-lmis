CREATE OR REPLACE FUNCTION nos_weekly_stock_history_after_2020_05_31()
...
BEGIN
  ...
  FOR one_friday IN (SELECT *
                     FROM generate_series('2020-05-31' :: DATE, last_movement_date :: DATE, '1 day')
...
DROP MATERIALIZED VIEW IF EXISTS vw_weekly_nos_soh_after_2020_05_31;

CREATE MATERIALIZED VIEW vw_weekly_nos_soh_after_2020_05_31 AS
(SELECT
 uuid_in(md5(random() :: TEXT || now() :: TEXT) :: cstring) AS uuid,
 *
 FROM nos_weekly_stock_history_after_2020_05_31()) WITH NO DATA;

-- View indexes:
CREATE UNIQUE INDEX idx_vw_weekly_nos_soh_after_2020_05_31 ON vw_weekly_nos_soh_after_2020_05_31 USING btree (uuid, facility_code, drug_code);


-- Permissions

ALTER TABLE public.vw_weekly_nos_soh_after_2020_05_31 OWNER TO openlmis;
GRANT ALL ON TABLE public.vw_weekly_nos_soh_after_2020_05_31 TO openlmis;
GRANT SELECT ON TABLE public.vw_weekly_nos_soh_after_2020_05_31 TO readonly;
GRANT ALL ON TABLE public.vw_weekly_nos_soh_after_2020_05_31 TO db_test;
GRANT SELECT ON TABLE public.vw_weekly_nos_soh_after_2020_05_31 TO postgres;
GRANT SELECT ON TABLE public.vw_weekly_nos_soh_after_2020_05_31 TO test1;


CREATE OR REPLACE FUNCTION refresh_weekly_nos_soh_after_2020_05_31()
  RETURNS INT LANGUAGE plpgsql
AS $$
BEGIN
  REFRESH MATERIALIZED VIEW CONCURRENTLY vw_weekly_nos_soh_after_2020_05_31;
  RETURN 1;
END $$;
