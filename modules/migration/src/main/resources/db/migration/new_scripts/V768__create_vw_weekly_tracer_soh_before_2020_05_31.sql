CREATE OR REPLACE FUNCTION tracer_drugs_weekly_stock_history_before_2020_05_31()
...
DROP MATERIALIZED VIEW IF EXISTS vw_weekly_tracer_soh_before_2020_05_31;

CREATE MATERIALIZED VIEW vw_weekly_tracer_soh_before_2020_05_31 AS (SELECT *
                                                  FROM tracer_drugs_weekly_stock_history_before_2020_05_31()) WITH NO DATA;

-- Permissions

ALTER TABLE public.vw_weekly_tracer_soh_before_2020_05_31 OWNER TO openlmis;
GRANT ALL ON TABLE public.vw_weekly_tracer_soh_before_2020_05_31 TO openlmis;
GRANT ALL ON TABLE public.vw_weekly_tracer_soh_before_2020_05_31 TO db_test;
GRANT SELECT ON TABLE public.vw_weekly_tracer_soh_before_2020_05_31 TO postgres;
GRANT SELECT ON TABLE public.vw_weekly_tracer_soh_before_2020_05_31 TO readonly;
GRANT SELECT ON TABLE public.vw_weekly_tracer_soh_before_2020_05_31 TO test1;

CREATE OR REPLACE FUNCTION refresh_weekly_tracer_soh_before_2020_05_31()
  RETURNS INT LANGUAGE plpgsql
AS $$
BEGIN
  REFRESH MATERIALIZED VIEW CONCURRENTLY vw_weekly_tracer_soh_before_2020_05_31;
  RETURN 1;
END $$;